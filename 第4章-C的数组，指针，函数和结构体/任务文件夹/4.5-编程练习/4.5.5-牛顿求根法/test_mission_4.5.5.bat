...
::元数据段
::data_version=202010261427
set bat_version=1.1.1beta 
set interactive=0
set mission_name=mission_4.5.5
set para[0]=5 3 1 11 5 3 -2
set para[1]=-1 4 9 -3 3 1 -2
set para[2]=-1 4 9 -3 3 1 0
set para[3]=1 -15 75 -125 -36 175 -2
set para[4]=1 -15 75 -125 -36 175 1
set para[5]=1 -15 75 -125 -36 175 5
set para[6]=1 -15 75 -125 -36 175 6
set paralist=0,1,6
set maxwaittime=2
