...
::元数据段
::data_version=202010252115
set bat_version=1.1.1beta 
set interactive=0
set mission_name=mission_4.5.3
set para[0]=1928 190 15
set para[1]=928 391 10
set para[2]=28 331 20
set para[3]=201 66 5
set para[4]=982 222 10
set para[5]=112 22 15
set para[6]=4983 1123 15
set paralist=0,1,6
set maxwaittime=5
