...
set interactive=1
set mission_name=mission_2.5.1
set para[0]=1 1 1 1
set para[1]=2000 10 10 13000000000
set para[2]=2011 10 01 13222010101
set para[3]=1990 09 19 85092019
set para[4]=221 1 1 18888888888
set para[5]=2913 01 03 19209190192
set paralist=0,1,5
