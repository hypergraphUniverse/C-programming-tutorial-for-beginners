...
4. 然后通过GitHub Desktop配置Git的邮箱。其实[这个介绍](https://docs.github.com/en/desktop/getting-started-with-github-desktop/configuring-git-for-github-desktop)更详细，下面的介绍比较简略：
...
名字随便填写，当然推荐和GitHub用户名一样，Email必须对的上就是了
